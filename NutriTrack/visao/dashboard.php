...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($tipo == 'nutricionista') {
        $usuario->setFormacao($_POST['formacao']);
        $usuario->setPreco_consulta($_POST['preco_consulta']);
    }
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
        ...
        $caminhoRelativo = "uploads/nutricionistas/" . $nomeArquivo;
        ...
        $usuario->setFoto($caminhoRelativo);
    }
    // Salvar no banco
...
<body>
    <div class="dashboard-container">
        ...
        <form method="POST" class="dados" enctype="multipart/form-data">
            <h2>Seus Dados</h2>
            ...
            ?>
            <label for="foto" style="color: green;">[Escolha a foto]</label>
            <input type="file" name="foto" id="foto" accept="image/*" style="border: none;margin:0;padding:0;" hidden>
            ...
            <?php if ($tipo == 'nutricionista'): ?>
                ...
                <input type="number" name="preco_consulta" id="preco_consulta" value="<?php echo htmlspecialchars($usuario->getPreco_consulta()); ?>" placeholder="Digite o preço (ex: 50,00)" step="0.01" min="30"required>
