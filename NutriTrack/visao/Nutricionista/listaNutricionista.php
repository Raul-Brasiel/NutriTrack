	...
	<body>
		...
		<table>
			...
			<?php foreach ($lista as $c) {    
				...
				$foto = !empty($c->getFoto()) ? $c->getFoto() : '../uploads/nutricionistas/default.png';

    			echo "<div class='foto'><img src='" . htmlspecialchars($foto) . "' alt='Foto de " . htmlspecialchars($c->getNome()) . "' /></div>";
				
				echo "<div class='info'>";
				echo "<h3>" . htmlspecialchars($c->getNome()) . "</h3>";
				echo "<p>" . htmlspecialchars($c->getFormacao()) . "</p>";
				echo "<p><strong>E-mail:</strong> " . htmlspecialchars($c->getEmail()) . "</p>";
				echo "<p><strong>Preço por Consulta:</strong> R$" . number_format($c->getPreco_consulta(), 2, ',', '.') . "</p>";
				echo "</div>";
				
				// Botão centralizado
				echo "<div class='button-container'>";
				echo "<a href='mailto:" . htmlspecialchars($c->getEmail()) . "' class='button'>Entrar em Contato</a>";
				echo "</div>";
